...
def attack(char_name: str, char_class: str) -> str:
    """DO returns message of damage.
    args:
    char_name -- имя персонажа.
    char_class -- класс персонажа возвращается из choice_char_class().
    """
...
def defence(char_name: str, char_class: str) -> str:
    """DO return message of blocked damage."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """DO return message of special attack."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не применил специального приема')
